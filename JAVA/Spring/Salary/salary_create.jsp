...
<title>Insert title here</title>
	...
	$(document).ready(function() { 
		$('#create').click(function() {
			var returnValue = confirm("소멸 후 데이터가 생성됩니다.\n\n 생성하시겠습니까?");
    		if(returnValue){
        		$('#salarycreateform').submit();
    		} else {
    			return;
    		}
		});
...
<body >
 <form class="form-horizontal" id = "salarycreateform" name = "salarycreateform" action="salaryCreate" method="POST" role="form" data-parsley-validate="true">
	 ...
	 <div class = "col-md-3">
		...
		<div class="row" style="border-color:#ffffff; border-style:solid;"></div>
	 	<div class="row" style="border-color:#ffffff; border-style:solid;"></div>
	 	 ...
	 	 <button type="button" id = "create" class="btn btn-info btn-sm" >생성</button>
