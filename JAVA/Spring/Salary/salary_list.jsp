	...
	<div class="contatiner"  style="height: 650px;backtround-color:#fff">
		...
		<div class="row">
			<div class="col-md-offset-2 col-md-8 text-center" style="margin-top:10px;background-color:#ccc;">
				...
				<span class="col-md-3" style=" border:1px solid #fff;"> 이름</span>
				...
				<span class="col-md-1" border:1px solid #fff;">합계</span>
		...
		<c:forEach var="salarys" items="${salarys}" >
			<div class="row">
				<div class="col-md-offset-2 col-md-8 text-center" style="background-color:#eeeeee">
					<span class="col-md-1" style="  height:40px;padding:2px">${salarys.no}</span>
					<span class="col-md-3" style=" border:1px solid #fff;height:40px;padding:2px;text-align:center" >
					
					<a href="salaryDetail?no=${salarys.no}">${salarys.name}</a>
					</span>
					<span class="col-md-2" style=" border:1px solid #fff;height:40px;padding:2px">${salarys.dept}</span>
					<span class="col-md-2" style=" border:1px solid #fff;height:40px;padding:2px;text-align:center">${salarys.base}</span>
					<span class="col-md-1" style="  height:40px;padding:2px">${salarys.extrapay1}</span>
					<span class="col-md-1" style="  height:40px;padding:2px">${salarys.extrapay2}</span>
					<span class="col-md-1" style="  height:40px;padding:2px">${salarys.base+salarys.extrapay1+salarys.extrapay2}</span>
					<span class="col-md-1"style ="text-align:center;"><input type="checkbox" id="unitchk" name="unitchk" value ="${salarys.no}"/>
					</span>
				</div>
			</div>
		</c:forEach>
