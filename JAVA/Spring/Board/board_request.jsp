...
<body >
 <form class="form-horizontal" action="loginup" method="POST" role="form" data-parsley-validate="true">
	...
	<div class = "col-md-4"></div>
	 ...
	 <div class = "col-md-4">
	 	<span class="text-success text-center"><h1>Login please</h1></span>
	 	
	 	<div class="row" style="border-color:#ffffff; ; border-style:solid;"></div>
	 	<div class="row" style="border-color:#ffffff; border-style:solid;"></div>
	 	<div class ="alert alert-danger fade in col-md-offset-2 text-center" >
	 		<strong>You have to login to use this board.</strong> 
	 	</div> 
	 	<div class="row">
	 	 <div class="col-md-4">
		 ...
		 <div class="row" style="border-color:#ffffff; border-style:solid;"></div>
	 	 ...
	 	 <button type="submit" class="btn btn-info btn-sm" >Login</button>
	  	  <a href="index"><button type="button" class="btn btn-info btn-sm" >Cancel</button></a>
	 	 </div>
