...
<body >
 <form class="form-horizontal" action="boardReplySave" method="POST" role="form" data-parsley-validate="true">
	 	...
	 	<div class="row">
	 	 ...
	 	 <div class="col-md-4"></div>
	  	 ...
	  	 <c:if test="${sessionid == 'admin' || sessionid == board.getB_id()}">
	  		<input type = "hidden" id= "b_ref", name = "b_ref" value="${board.getB_ref()}">
