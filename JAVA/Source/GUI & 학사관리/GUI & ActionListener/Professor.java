...
public class Professor implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		JFrame frame1 = new JFrame("Professor");
		...
		ActionListener listener = new ProfessorActionListener(frame,frame1,table,code,name,confirmchk,model,find);
		...
		MouseListener mouse = new ProfessorMouseListener(code,name,model);
