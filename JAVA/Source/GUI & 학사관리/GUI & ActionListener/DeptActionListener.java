...
public class DeptActionListener implements ActionListener {
	JFrame frame;
	JFrame frame1;
	JTable table;
	JTextField code;
	...
	public DeptActionListener(JFrame frame, JFrame frame1, JTable table, JTextField code, JTextField name, boolean confirmchk, DefaultTableModel model,JTextField find) {
		this.frame = frame;
		this.frame1 = frame1;
		this.code = code;
		this.name = name;
	...
	private void updateRow(DeptBean data) {
	...
	private void insertRow(DeptBean data) {
		if ( !confirmchk ){
